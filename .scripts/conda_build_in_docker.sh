...
docker run --rm $CONDA_ENVS -e CONDA_CHANNELS=$3 -v $ABS_RECIPE_PATH:/recipe:ro -v $ABS_OUTPUT_PATH:/output:Z condaforge/linux-anvil:latest bash -x /recipe/$BUILDSCRIPT
